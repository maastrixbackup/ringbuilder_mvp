...
@section('content')
    @include('components.page-header', [
        ...
        'breadcrumbs' => [
            ...
            ['name' => ' / Shape Edit'], // No URL = current page
        ],
    ])
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.update-d-shape', $shape->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-2">
                        ...
                        <div class="row mb-2 ">
                            ...
                            <div class="form-group col-md-4">
                                <img id="imagePreview" src="{{ asset('storage/images/shapes/' . $shape->shape_image) }}"
                                    alt="Image Preview" @if (!isset($shape->shape_image)) style="display:none;" @endif
