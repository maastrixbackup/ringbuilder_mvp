            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.rings.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-2">
                            <label for="ring_price" class="col-md-3 my-2 d-flex justify-content-end ">Shape &
                                Price*</label>
                            <div class="form-group col-md-8">
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Price*</th>
                                            <th>
                                                <a class="btn btn-primary btn-sm" id="ringSPrice"><i class="ti ti-plus"
                                                        aria-hidden="true"></i>
                                                </a>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody id="ringPriceBody">
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" name="ring_price[]"
                                                    id="ring_price" required placeholder="">
                                            </td>
                                            <td>
                                                {{-- <a class="btn btn-danger btn-sm remove-shape-price"><i class="ti ti-minus"
                                                        aria-hidden="true"></i>
                                                </a> --}}
                                            </td>
                                        </tr>
            ...
            $('#ringSPrice').on('click', function() {
                var htmlRow = `
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-danger btn-sm remove-shape-price"><i class="ti ti-minus"
                                            aria-hidden="true"></i>
                                    </button>
                                </td>
                            </tr>
                        `;
                $('#ringPriceBody').append(htmlRow);
            });

            $(document).on('click', '.remove-shape-price', function() {
